-- Migration: 000024_enhance_extend_session.up.sql
-- 1. Extend session langsung PAID (no pending confirmation)
-- 2. Tambah paid_at timestamp
...
BEGIN
    ...
    -- FIX: langsung PAID, tidak perlu konfirmasi
    ...
    VALUES(v_payment_id,p_session_id,v_amount,v_voucher_discount,0,v_final_amount,'cash','paid',p_cash_received,v_change,v_voucher_id,p_notes,v_now,v_now,v_now);
    RETURN QUERY SELECT p_session_id,v_new_booked,v_new_end,v_payment_id,v_amount,v_voucher_discount,v_final_amount,p_cash_received,v_change,v_voucher_id,'paid'::VARCHAR,v_now;
END; $$;
